        ...
        <div class="container-fluid">
            <div class="card rounded-3 shadow">
                <div class="card-header p-3 py-2">
                    <div class="pt-1">
                        <p class="text-sm mb-0 text-capitalize font-weight-bold">Ubah Surat Masuk</p>
                    </div>
                </div>
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-2">
                                <input type="text" name="nomor_urut" id="nomor_urut" class="form-control"
                                    value="{{ old('nomor_urut', $surat->nomor_urut) }}" readonly>
                            </div>
                        </div>
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-3">
                                <input type="datetime-local" name="tanggal_catat" id="tanggal_catat"
                                    ...
                                    value="{{ old('tanggal_catat', $surat->tanggal_catat) }}">
                                @error('tanggal_catat')
                            ...
                            <div class="col-md-6">
                                <select id="klasifikasi_surat_id" name="klasifikasi_surat_id"
                                    ...
                                    @foreach ($klasifikasi as $item)
                                        @if (old('klasifikasi_surat_id', $surat->klasifikasi_surat_id) == $item->id)
                                    ...
                                    @foreach ($pamongs as $pamong)
                                        <div class="col-md-6">
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="checkbox" name="pamong_id[]"
                                                    value="{{ $pamong->id }}" id="pamong_{{ $pamong->id }}"
                                                    @if (is_array($surat->pamong_id) && in_array($pamong->id, $surat->pamong_id)) checked @endif>
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-10">
                                <input type="text" name="isi_disposisi" id="isi_disposisi" class="form-control"
                                    value="{{ old('isi_disposisi', $surat->isi_disposisi) }}">
                            </div>
                        </div>
                    </div>
