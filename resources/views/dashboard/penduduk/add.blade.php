                            ...
                            <div class="col-auto">
                                <select id="keluarga_id" name="keluarga_id"
                                    ...
                                    @foreach ($keluarga as $keluarga)
                                        @if (old('keluarga_id') == $keluarga->id)
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="number" name="nik" id="nik"
                                                ...
                                                value="{{ old('nik') }}" placeholder="Nomor Induk Penduduk">
                                        </div>
                                        @error('nik')
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select id="jenis_kelamin_id" name="jenis_kelamin_id"
                                            ...
                                            @foreach ($jenis_kelamin as $item)
                                                @if (old('jenis_kelamin_id') == $item->id)
                                                    <option value="{{ $item->id }}" selected>
                                                        {{ $item->nama }}
                                                    </option>
                                                @else
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select id="status_rekam_ktp_id" name="status_rekam_ktp_id"
                                            ...
                                            @foreach ($rekam_ektp as $item)
                                                @if (old('status_rekam_ktp_id') == $item->id)
                                                    <option value="{{ $item->id }}" selected>
                                                        {{ $item->nama }}
                                                    </option>
                                                @else
                                ...
                                <div class="form-group row mb-3">
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="no_akta_lahir" id="no_akta_lahir"
                                            class="form-control" value="{{ old('no_akta_lahir') }}"
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="number" name="anak_ke" id="anak_ke" class="form-control"
                                            value="{{ old('anak_ke') }}" placeholder="0">
                                    </div>
                                    <div class="col-md-4">
                                ...
                                <div class="form-group row mb-3">
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="berat_lahir" id="berat_lahir" class="form-control"
                                            value="{{ old('berat_lahir') }}" placeholder="Berat Lahir">
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="panjang_lahir" id="panjang_lahir"
                                            class="form-control" value="{{ old('panjang_lahir') }}"
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select id="tempat_kelahiran_id" name="tempat_kelahiran_id"
                                            ...
                                            @foreach ($tempat_kelahiran as $item)
                                                @if (old('tempat_kelahiran_id') == $item->id)
                                                    <option value="{{ $item->id }}" selected>
                                                        {{ $item->nama }}
                                                    </option>
                                                @else
                                ...
                                <div class="form-group row mb-3">
                                    <div class="col-md-4">
                                        ...
                                        <select id="warga_negara_id" name="warga_negara_id"
                                            ...
                                            @foreach ($warga_negara as $item)
                                                @if (old('warga_negara_id') == $item->id)
                                                    <option value="{{ $item->id }}" selected>
                                                        {{ $item->nama }}
                                                    </option>
                                                @else
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="no_paspor" id="no_paspor" class="form-control"
                                            value="{{ old('no_paspor') }}" placeholder="Nomor Paspor">
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <input type="date" name="tanggal_akhir_paspor" id="tanggal_akhir_paspor"
                                            class="form-control" value="{{ old('tanggal_akhir_paspor') }}">
                                    </div>
                                </div>
                                <div class="form-group row mb-3">
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="no_kitas" id="no_kitas" class="form-control"
                                            value="{{ old('no_kitas') }}" placeholder="Nomor Kitas/Kitap">
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <input type="date" name="tanggal_akhir_kitas" id="tanggal_akhir_kitas"
                                            class="form-control" value="{{ old('tanggal_akhir_kitas') }}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <input type="number" name="nik_ayah" id="nik_ayah" class="form-control"
                                            value="{{ old('nik_ayah') }}" placeholder="NIK Lengkap Ayah">
                                    </div>
                                </div>
                                <div class="form-group row mb-3">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <input type="number" name="nik_ibu" id="nik_ibu" class="form-control"
                                            value="{{ old('nik_ibu') }}" placeholder="NIK Lengkap Ibu">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="email" name="email" id="email" class="form-control"
                                            value="{{ old('email') }}" placeholder="Alamat surat elektronik">
                                    </div>
                                </div>
                                <div class="form-group row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="alamat_sekarang" id="alamat_sekarang"
                                            class="form-control" value="{{ old('alamat_sekarang') }}"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="alamat_sebelumnya" id="alamat_sebelumnya"
                                            class="form-control" value="{{ old('alamat_sebelumnya') }}"
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="no_akta_kawin" id="no_akta_kawin"
                                            class="form-control" value="{{ old('no_akta_kawin') }}"
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="date" name="tanggal_kawin" id="tanggal_kawin"
                                            class="form-control" value="{{ old('tanggal_kawin') }}">
                                    </div>
                                </div>
                                <div class="form-group row mb-3">
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="no_akta_cerai" id="no_akta_cerai"
                                            class="form-control" value="{{ old('no_akta_cerai') }}"
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="date" name="tanggal_cerai" id="tanggal_cerai"
                                            class="form-control" value="{{ old('tanggal_cerai') }}">
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select id="golongan_darah_id" name="golongan_darah_id"
                                            ...
                                            @foreach ($golongan_darah as $item)
                                                @if (old('golongan_darah_id') == $item->id)
                                                    <option value="{{ $item->id }}" selected>
                                                        {{ $item->nama }}
                                                    </option>
                                                @else
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select id="sakit_menahun_id" name="sakit_menahun_id"
                                            ...
                                            @foreach ($sakit_menahun as $item)
                                                @if (old('sakit_menahun_id') == $item->id)
                                                    <option value="{{ $item->id }}" selected>
                                                        {{ $item->nama }}
                                                    </option>
                                                @else
