        ...
        <div class="container-fluid">
            <div class="card rounded-3 shadow">
                <div class="card-header p-3 py-2">
                    <div class="pt-1">
                        <p class="text-sm mb-0 text-capitalize font-weight-bold">Edit Surat Keputusan
                            {{ $setting->sebutan_kepala_desa }}</p>
                    </div>
                </div>
                <form action="{{ route('surat-keputusan.update', $surat->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                    <div class="card-body">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-5">
                                <p class="text-sm">{{ $surat->dokumen ?? '-' }}</p>
                                <input type="hidden" name="oldDokumen" value="{{ $surat->dokumen }}">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-4">
                                <input type="text" name="nomor_keputusan" id="nomor_keputusan"
                                    ...
                                    value="{{ old('nomor_keputusan', $surat->nomor_keputusan) }}">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-3">
                                <input type="date" name="tanggal_keputusan" id="tanggal_keputusan"
                                    ...
                                    value="{{ old('tanggal_keputusan', $surat->tanggal_keputusan) }}">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="uraian_singkat" id="uraian_singkat"
                                    ...
                                    value="{{ old('uraian_singkat', $surat->uraian_singkat) }}">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-4">
                                <input type="text" name="nomor_dilaporkan" id="nomor_dilaporkan"
                                    ...
                                    value="{{ old('nomor_dilaporkan', $surat->nomor_dilaporkan) }}">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-3">
                                <input type="date" name="tanggal_dilaporkan" id="tanggal_dilaporkan"
                                    ...
                                    value="{{ old('tanggal_dilaporkan', $surat->tanggal_dilaporkan) }}">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-9">
                                <textarea name="keterangan" id="keterangan" cols="30" rows="10" class="form-control">{{ old('keterangan', $surat->keterangan) }}</textarea>
                            </div>
                        </div>
                    </div>
