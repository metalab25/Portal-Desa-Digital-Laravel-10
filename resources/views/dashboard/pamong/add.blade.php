                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" name="nip" id="nip" class="form-control"
                                            value="{{ old('nip') }}" placeholder="Tuliskan NIP/NIAP">
                                    </div>
                                </div>
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" name="no_sk" id="no_sk" class="form-control"
                                            value="{{ old('no_sk') }}" placeholder="Tuliskan Nomor SK Pengangkatan">
                                    </div>
                                </div>
                                <div class="form-group row mb-3">
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" name="nama" id="nama" class="form-control"
                                            value="{{ old('nama') }}" placeholder="Nama Lengkap Pejabat">
                                    </div>
                                    <div class="col-md-4">
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" name="nik" id="nik" class="form-control"
                                            value="{{ old('nik') }}" placeholder="NIK Pejabat">
                                    </div>
                                    <div class="col-md-4">
                                        <div class="text-sm text-danger pt-2">Diisi apabila bukan penduduk
                                            {{ $setting->sebutan_desa }}</div>
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" name="tempat_lahir" id="tempat_lahir" class="form-control"
                                            value="{{ old('tempat_lahir') }}" placeholder="Tuliskan Tempat Lahir">
                                    </div>
                                    <div class="col-md-4">
                                        <div class="text-sm text-danger pt-2">Diisi apabila bukan penduduk
                                            {{ $setting->sebutan_desa }}</div>
