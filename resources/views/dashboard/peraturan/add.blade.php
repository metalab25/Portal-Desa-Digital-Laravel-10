                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-3">
                                <input type="date" name="tanggal_lembaran_desa" id="tanggal_lembaran_desa"
                                    ...
                                    value="{{ old('tanggal_lembaran_desa') }}">
