<div class="modal fade" id="modal-create-II" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    aria-labelledby="modal-form" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header bg-warning">
                <h1 class="modal-title fs-6 font-outfit" id="exampleModalLabel">Tambah Sumber Kode II</h1>
            </div>
                ...
                <div class="modal-body">
                    <div class="form-group mb-2">
                        ...
                        <select class="form-control form-select @error('parent') is-invalid @enderror" id="parent"
                            name="parent">
                            <option value="">-- Pilih Kode I Turunan --</option>
                            @foreach ($kodeI as $item)
