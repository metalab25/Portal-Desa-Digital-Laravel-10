        ...
        <div class="container-fluid">
            <div class="card rounded-3 shadow">
                <div class="card-header p-3 py-2">
                    <div class="pt-1">
                        <p class="text-sm mb-0 text-capitalize font-outfit">Tambah Program Bantuan
                        </p>
                    </div>
                </div>
                <form action="{{ route('bantuan.store') }}" method="post">
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-md-10">
                                <select class="form-control form-select @error('bantuan_sasaran_id') is-invalid @enderror"
                                    ...
                                    @foreach ($sasaran as $item)
                                        @if (old('bantuan_sasaran_id') == $item->id)
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-10">
                                <textarea id="deskripsi" name="deskripsi" class="form-control" rows="8" cols="10">{{ old('deskripsi') }}</textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <input type="date" name="mulai" id="mulai"
                                    class="form-control @error('mulai') is-invalid @enderror" value="{{ old('mulai') }}">
                                @error('mulai')
                                    <div class="invalid-feedback">
                            ...
                            <div class="col-md-4">
                                <input type="date" name="akhir" id="akhir"
                                    class="form-control @error('akhir') is-invalid @enderror" value="{{ old('akhir') }}">
                                @error('akhir')
                                    <div class="invalid-feedback">
